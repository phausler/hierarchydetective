...
NSString *const HDGCDAsyncSocketException = @"HDGCDAsyncSocketException";
NSString *const HDGCDAsyncSocketErrorDomain = @"HDGCDAsyncSocketErrorDomain";

NSString *const HDGCDAsyncSocketQueueName = @"HDGCDAsyncSocket";
NSString *const HDGCDAsyncSocketThreadName = @"HDGCDAsyncSocket-CFStream";

#if SECURE_TRANSPORT_MAYBE_AVAILABLE
NSString *const HDGCDAsyncSocketSSLCipherSuites = @"HDGCDAsyncSocketSSLCipherSuites";
#if TARGET_OS_IPHONE
NSString *const HDGCDAsyncSocketSSLProtocolVersionMin = @"HDGCDAsyncSocketSSLProtocolVersionMin";
NSString *const HDGCDAsyncSocketSSLProtocolVersionMax = @"HDGCDAsyncSocketSSLProtocolVersionMax";
#else
NSString *const HDGCDAsyncSocketSSLDiffieHellmanParameters = @"HDGCDAsyncSocketSSLDiffieHellmanParameters";
#endif
#endif

enum HDGCDAsyncSocketFlags
{
...
@interface HDGCDAsyncSocket ()
{
	...
	HDGCDAsyncReadPacket *currentRead;
	HDGCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	HDGCDAsyncSocketPreBuffer *preBuffer;
	...
	HDGCDAsyncSocketPreBuffer *sslPreBuffer;
...
@interface HDGCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation HDGCDAsyncSocketPreBuffer
...
/**
 * The HDGCDAsyncReadPacket encompasses the instructions for any given read.
 * The content of a read packet allows the code to determine if we're:
 *  - reading to a certain length
 *  - reading to a certain separator
 *  - or simply reading the first chunk of available data
**/
@interface HDGCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(HDGCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation HDGCDAsyncReadPacket
...
/**
 * The HDGCDAsyncWritePacket encompasses the instructions for any given write.
**/
@interface HDGCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation HDGCDAsyncWritePacket
...
/**
 * The HDGCDAsyncSpecialPacket encompasses special instructions for interruptions in the read/write queues.
 * This class my be altered to support more than just TLS in the future.
**/
@interface HDGCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation HDGCDAsyncSpecialPacket
...
@implementation HDGCDAsyncSocket
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([HDGCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[HDGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
	}
	return self;
}
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			// Create HDGCDAsyncSocket instance for accepted socket
			
			HDGCDAsyncSocket *acceptedSocket = [[HDGCDAsyncSocket alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"HDGCDAsyncSocketConnectTimeoutError",
	                                                     @"HDGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Attempt to connect to host timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey: errMsg};
	
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"HDGCDAsyncSocketReadMaxedOutError",
														 @"HDGCDAsyncSocket", [NSBundle mainBundle],
														 @"Read operation reached set maximum length", nil);
	
	NSDictionary *info = @{NSLocalizedDescriptionKey: errMsg};
	
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"HDGCDAsyncSocketReadTimeoutError",
	                                                     @"HDGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Read operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey: errMsg};
	
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"HDGCDAsyncSocketWriteTimeoutError",
	                                                     @"HDGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Write operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey: errMsg};
	
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}

- (NSError *)connectionClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"HDGCDAsyncSocketClosedError",
	                                                     @"HDGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Socket closed by remote peer", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey: errMsg};
	
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:HDGCDAsyncSocketErrorDomain code:HDGCDAsyncSocketOtherError userInfo:userInfo];
}
                        ...
                        tag:(long)tag
{
	...
	HDGCDAsyncReadPacket *packet = [[HDGCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[HDGCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[HDGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued HDGCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued HDGCDAsyncReadPacket");
...
- (void)completeCurrentRead
{
	...
	{
		__strong id theDelegate = delegate;
		HDGCDAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		__strong id theDelegate = delegate;
		HDGCDAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	HDGCDAsyncWritePacket *packet = [[HDGCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[HDGCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[HDGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued HDGCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued HDGCDAsyncWritePacket");
...
- (void)doWriteData
{
	...
	// Note: This method is not called if currentWrite is a HDGCDAsyncSpecialPacket (startTLS packet)
...
- (void)doWriteTimeout
{
	...
	{
		__strong id theDelegate = delegate;
		HDGCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	HDGCDAsyncSpecialPacket *packet = [[HDGCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			HDGCDAsyncSpecialPacket *tlsPacket = (HDGCDAsyncSpecialPacket *)currentRead;
...
{
	HDGCDAsyncSocket *asyncSocket = (__bridge HDGCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	// 7. kCFStreamSSLLevel (HDGCDAsyncSocketSSLProtocolVersionMin / HDGCDAsyncSocketSSLProtocolVersionMax)
	// 8. HDGCDAsyncSocketSSLCipherSuites
	// 9. HDGCDAsyncSocketSSLDiffieHellmanParameters (Mac)
	...
	#if TARGET_OS_IPHONE
	{
		...
		NSString *sslMinLevel = tlsSettings[HDGCDAsyncSocketSSLProtocolVersionMin];
		NSString *sslMaxLevel = tlsSettings[HDGCDAsyncSocketSSLProtocolVersionMax];
		...
		if (sslLevel)
		{
			if (sslMinLevel || sslMaxLevel)
			{
				LogWarn(@"kCFStreamSSLLevel security option ignored. Overriden by "
						@"HDGCDAsyncSocketSSLProtocolVersionMin and/or HDGCDAsyncSocketSSLProtocolVersionMax");
			}
			else
			{
	...
	value = tlsSettings[HDGCDAsyncSocketSSLCipherSuites];
	if (value)
	{
	...
	// 9. HDGCDAsyncSocketSSLDiffieHellmanParameters
	
	#if !TARGET_OS_IPHONE
	value = [tlsSettings objectForKey:HDGCDAsyncSocketSSLDiffieHellmanParameters];
	if (value)
	{
	...
	sslPreBuffer = [[HDGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[HDGCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[HDGCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
{
	[[NSThread currentThread] setName:HDGCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(HDGCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(HDGCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	HDGCDAsyncSocket *asyncSocket = (__bridge HDGCDAsyncSocket *)pInfo;
